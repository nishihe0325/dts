...
public class CanalRunningStatusMvcServiceImpl implements CanalRunningStatusMvcService {
    ...
    public CanalRunningInfoWrapper canalRunningInfoList(Map<String, Object> condition) {
        ...
        try {
            ...
            allCanalServers = allCanalServers != null ? allCanalServers : new ArrayList<CanalServerInfo>();
            List<CanalServer> canalServers = canalServerService.findAll();
            canalServers = canalServers != null ? canalServers : new ArrayList<CanalServer>();
            for (CanalServer server : canalServers) {
                CanalServerInfo canalServerInfo = new CanalServerInfo();
                canalServerInfo.setCanalHost(server.getHost());
                canalServerInfo.setCanalHostName(server.getHostName());
                canalServerInfo.setCanalPort(server.getPort());
                allCanalServers.add(canalServerInfo);
            }
    ...
    public CanalInstanceRunningData canalRunningInfoDetail(String canalHost, String canalHostName, int canalPort, String destination) {
     ...
     *
     * @param canalHost     canal server主机地址
     * @param canalHostName canal server主机名称
     * @param canalPort     canal server主机端口
     * @return
     */
    private CanalServerRunningData getCanalServerRunningData(String canalHost, String canalHostName, int canalPort, String destination) {
