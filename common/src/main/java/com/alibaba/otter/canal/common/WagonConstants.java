...
public final class WagonConstants {
    ...
    public static final String URL_REGISTER_SERVICE = "/canal/registerService.json";
    ...
    public static final String URL_GET_MONITOR_DATA = "/getMonitorData";
    ...
    public static final String PRO_MQ_TYPE = "mq.type";
