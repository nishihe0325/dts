...
public final class WagonConstants {
    ...
    public static final String URL_REMOVE_CANAL_SERVICE = "/removeCanalService";
    public static final String URL_UPDATE_CANAL_INSTANCE_STATE= "/updateCanalInstanceState";
    public static final String URL_REMOVE_CANAL_INSTANCE = "/removeCanalInstance";
    public static final String URL_REMOVE_CANAL_SERVER = "/removeCanalServer";
    ...
    public static final String MODEL_CUR_TIME = "curTime";
    ...
    public static final String INSTANCE_LIST_STATE = "canalInstanceList";
